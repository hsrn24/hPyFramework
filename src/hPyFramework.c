...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hSystem_delay_ms_obj, 1, 1, hSystem_delay_ms);
mp_obj_t hSystem_delay_us(mp_obj_t self_in, mp_obj_t arg1);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hSystem_delay_us_obj, 1, 1, hSystem_delay_us);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hLED_on_obj, 0, 0, hLED_on);
mp_obj_t hLED_off(mp_obj_t self_in);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hLED_off_obj, 0, 0, hLED_off);
mp_obj_t hLED_toggle(mp_obj_t self_in);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hLED_toggle_obj, 0, 0, hLED_toggle);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hMotor_setPower_obj, 1, 1, hMotor_setPower);
mp_obj_t hMotor_rotAbs(mp_obj_t self_in, mp_obj_t arg1);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hMotor_rotAbs_obj, 1, 1, hMotor_rotAbs);
mp_obj_t hMotor_setParallelMode(mp_obj_t self_in);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hMotor_setParallelMode_obj, 0, 0, hMotor_setParallelMode);
mp_obj_t hMotor_setSingleMode(mp_obj_t self_in);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hMotor_setSingleMode_obj, 0, 0, hMotor_setSingleMode);
mp_obj_t hMotor_resetEncoderCnt(mp_obj_t self_in);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hMotor_resetEncoderCnt_obj, 0, 0, hMotor_resetEncoderCnt);
mp_obj_t hMotor_getEncoderCnt(mp_obj_t self_in);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hMotor_getEncoderCnt_obj, 0, 0, hMotor_getEncoderCnt);
...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hButton_isPressed_obj, 0, 0, hButton_isPressed);
mp_obj_t hButton_waitForPressed(uint n_args, const mp_obj_t *args);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hButton_waitForPressed_obj, 0, 1, hButton_waitForPressed);
mp_obj_t hButton_waitForReleased(uint n_args, const mp_obj_t *args);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(hButton_waitForReleased_obj, 0, 1, hButton_waitForReleased);
