...
mp_obj_t hLED_on(mp_obj_t self_in) {
	mp_obj_hLED_t *self = (mp_obj_hLED_t*)self_in;
...
mp_obj_t hButton_isPressed(mp_obj_t self_in) {
	mp_obj_hButton_t *self = (mp_obj_hButton_t*)self_in;
...
void reg()
{
	...
	{
		mp_obj_hLED_t *v = m_new_obj_var(mp_obj_hLED_t, char*, 0);
		v->hObj = &LED1;
	...
	{
		mp_obj_hButton_t *v = m_new_obj_var(mp_obj_hButton_t, char*, 0);
		v->hObj = &hBtn1;
